...
# And crop to our area of interest, a boundary box (bbox)
Borders_StateCollege <- st_crop(st_geometry(CentreCounty),MetaData.bbox)
...
```{r}
# Add in elevation
#Elevation.Raster <- get_elev_raster(MetaData.bbox, z = 14,clip="bbox")
